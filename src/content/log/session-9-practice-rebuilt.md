...
During this train of thought I was having about curating an experience in public, I opened my site on my phone. Immediately I noticed the navigation clipping on mobile. Knowing full well that most people who open this site will open it on a phone, I started to review the other pages, and soon it became a full audit unto itself. To start, I stopped assuming people would engage with the interactivity of the Venn diagram on the Practice page the same way across devices. I moved the hint above the diagram instead of below, to accommodate how people scroll on their phone, and the hint text was reworded so it no longer assumed a pointer.
